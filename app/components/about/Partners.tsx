  ...
  return (
    <section className="py-16 px-4 md:px-8 bg-gray-50">
      <div className="max-w-5xl mx-auto text-center mb-12">
        ...
        <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">Trusted by organizations across technology, consumer, entertainment, and sports sectors.</p>
      </div>
