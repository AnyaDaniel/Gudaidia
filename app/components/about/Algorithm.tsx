...
const Algorithm = () => {
  return (
    <div className="bg-black text-white flex flex-col md:flex-row py-8 md:py-12 px-4 md:px-8 lg:px-12 justify-center items-start md:items-center gap-5 max-w-7xl mx-auto">
      ...
      <div className="w-full md:w-1/2">
        <h1 className="font-bold pb-4 md:pb-5 text-2xl md:text-3xl lg:text-4xl text-left">
        ...
        <p className="text-base md:text-lg leading-relaxed text-left mt-4">
