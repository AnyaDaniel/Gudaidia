  ...
  return (
    <div className='flex flex-col md:flex-row mb-6 pt-20 justify-center items-center gap-5 px-4 md:px-8 w-full'>
        ...
        <div className="w-full md:w-1/2">
            ...
            <p className="text-base md:text-lg text-justify leading-relaxed">The Gʊd Aɪ'diə Company partners with leaders who are building something meaningful, evolving what exists, or reimagining what's possible next. The work is collaborative by nature, grounded in real-world execution, and guided by a deep respect for each partner's vision.
