...
const About = () => {
  return (
    <div className="w-full bg-gray-50 px-4 sm:px-8 py-12">
        <div className="my-4 text-center">
            <h1 className='text-black text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4'>OUR STORY</h1>
        </div>
        <div className="text-sm sm:text-base px-0 sm:px-4 md:flex justify-center items-start w-full">
            
            <div className="sm:text-base md:text-lg text-center">
