        ...
        <div className="bg-[url('/hero3.jpg')] bg-cover flex justify-center items-center h-screen text-left ">
            <div className="bg-[#00000050] w-full h-full flex items-center justify-start">
              <div className='mt-36 md:mt-52 md:ml-28 w-full max-w-5xl h-full px-4 md:px-8 md:pr-20'>
                  ...
                  <p className="text-base md:text-lg text-white leading-relaxed">Across Consumer, Entertainment &amp; Recreation, Technology, and Energy, The Gʊd Aɪ&apos;diə Company supports organizations that are building, refining, or repositioning. The focus is simple: <span className="font-semibold">make ideas usable, decisions clearer, and progress visible</span>.</p>
